package com.ysj.spring.aop.config;
...
public class AdviceAspectConfig {
    ...
    @Pointcut("@annotation(com.ysj.spring.aop.anno.AdminOnly) && within(com.ysj..*)")
    public void matchAnno(){}

    @Pointcut("execution(* *..find*(Long)) && within(com.ysj..*) ")
    public void matchLongArg(){}

    @Pointcut("execution(public * com.ysj.spring.aop.service..*Service.*(..) throws java.lang.IllegalAccessException) && within(com.ysj..*)")
    public void matchException(){}

    @Pointcut("execution(String com.ysj..*.*(..)) && within(com.ysj..*)")
